...
<br/>
<b>⑆</b> I'm also trying to write a "stats-predictor" for basketball in Python to predict a season for a player (a la Basketball Reference's season-asjusted predictions, but with different stats as inputs and a different fit equation) <br/></blockquote>
